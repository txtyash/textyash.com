import { hasLower, hasNum, hasSpecial, hasSpecialExceptPeriod, hasUpper, isValidEmail } from "./helpers";
...
export function checkConfirmPassword(password: string, confirmPassword: string): string | null {
